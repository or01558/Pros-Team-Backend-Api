...
import { EpicgamesOAuthData, STWMissionAlertData, STWMissionData, STWProfileLockerSlotData, STWTheaterData, TournamentWindowTemplateData } from './httpResponses';
...
export declare type PartyMemberSchema = Partial<typeof defaultPartyMemberMeta>;
export declare type PartySchema = Partial<typeof defaultPartyMeta> & {
...
export declare type Schema = Record<string, string | undefined>;
export declare type Language = 'de' | 'ru' | 'ko' | 'zh-hant' | 'pt-br' | 'en' | 'it' | 'fr' | 'zh-cn' | 'es' | 'ar' | 'ja' | 'pl' | 'es-419' | 'tr';
...
export declare type Platform = 'WIN' | 'MAC' | 'PSN' | 'XBL' | 'SWT' | 'IOS' | 'AND' | 'PS5' | 'XSX';
...
export declare type PresenceOnlineType = 'online' | 'away' | 'chat' | 'dnd' | 'xa';
export declare type StatsPlaylistType = 'other' | 'solo' | 'duo' | 'squad' | 'ltm';
...
export declare type UserSearchPlatform = 'epic' | 'psn' | 'xbl' | 'steam';
...
export declare type STWSurvivorType = 'special' | 'manager' | 'basic';
export declare type STWItemRarity = 'c' | 'uc' | 'r' | 'vr' | 'sr' | 'ur';
export declare type STWItemTier = 1 | 2 | 3 | 4 | 5 | 6;
export declare type STWSurvivorGender = 'male' | 'female';
...
export declare type STWSurvivorSquadType = 'medicine' | 'arms' | 'synthesis' | 'scavenging';
...
export declare type STWHeroType = 'commando' | 'constructor' | 'outlander' | 'ninja';
export declare type STWSchematicType = 'ranged' | 'melee' | 'trap' | 'other';
export declare type STWSchematicRangedSubType = 'assault' | 'launcher' | 'pistol' | 'shotgun' | 'smg' | 'sniper';
export declare type STWSchematicMeleeSubType = 'blunt' | 'blunt_hammer' | 'edged_axe' | 'edged_scythe' | 'edged_sword' | 'piercing_spear';
export declare type STWSchematicTrapSubType = 'ceiling' | 'floor' | 'wall';
export declare type STWSchematicSubType = STWSchematicRangedSubType | STWSchematicMeleeSubType | STWSchematicTrapSubType;
export declare type STWSchematicAlterationRarity = 'common' | 'uncommon' | 'rare' | 'epic' | 'legendary';
export declare type STWSchematicEvoType = 'ore' | 'crystal';
